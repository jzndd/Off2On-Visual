...
class Trainer:
    ...
    def __init__(self, cfg, root_dir):
        ...
        # init agent
        if cfg.ac_type == "rlpd" or cfg.ac_type == "drqv2":
    ...
    def run(self):
        ...
        if self._cfg.train_with_bc:
            raise NotImplementedError("RLPD / DrQv2 Agent doesn't need to train with bc")
            ...
            while not done:
                ...
                with torch.no_grad():
                    ...
                    if isinstance(real_act, Tuple):
                        raise NotImplementedError("Off policy agent should just return action")
                    ...
                    rb.store(obs, next_obs, rew, done, real_act)
