...
#### for metaworld
```bash
python main2D_offpolicy.py common.devices=[4] seed=100 ac_type=vrl3 task=door-lock-v2 actor_critic.training.batch_size=512 agent.actor_critic_cfg.online_lr=1e-4

python main2D_offpolicy.py common.devices=[5] seed=100 ac_type=vrl3 task=door-lock-v2 actor_critic.training.batch_size=512 is_sparse_reward=False agent.actor_critic_cfg.online_lr=1e-4
```
...
```python
# sparse reward
python main2D_offpolicy_v2.py common.devices=[0] seed=100 ac_type=drqv2-rlpd task=door-lock-v2 actor_critic.training.batch_size=256 train_with_bc=False is_sparse_reward=False agent.actor_critic_cfg.online_lr=1e-4

# dense reward
python main2D_offpolicy_v2.py common.devices=[1] seed=100 ac_type=drqv2-rlpd task=door-lock-v2 actor_critic.training.batch_size=256 train_with_bc=False is_sparse_reward=True agent.actor_critic_cfg.online_lr=1e-4
